...
The current AI starter dependency advisory inventory and its remediation constraint are documented in [`integration/agent-eval/SECURITY.md`](integration/agent-eval/SECURITY.md).
