> Evaluation fixture adapted from an official starter snapshot. Retained upstream prose is provenance; use this repository's skill references and current tldraw docs for package and licensing decisions.
