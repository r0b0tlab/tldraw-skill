...
import { HighlightEvalActionUtil } from '../actions/HighlightEvalActionUtil'
...
import { EvalSessionPartUtil } from '../parts/EvalSessionPartUtil'
...
export const AGENT_MODE_DEFINITIONS = [
	...
	},
	{
		...
		parts: [
			...
			// Eval harness session metadata (custom)
			EvalSessionPartUtil.type,
		],
