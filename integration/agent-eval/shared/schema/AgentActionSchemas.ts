...
// Highlight Eval Action (repo-owned custom action for agent-eval harness)
export const HighlightEvalAction = z
	.object({
		_type: z.literal('highlight-eval'),
		shapeId: SimpleShapeIdSchema,
		intent: z.string(),
...
export type HighlightEvalAction = z.infer<typeof HighlightEvalAction>
