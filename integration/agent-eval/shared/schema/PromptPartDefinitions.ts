...
/** Repo-owned eval session metadata (provider mode must stay honest). */
...
// EvalSession - harness metadata; notes are treated as untrusted canvas-adjacent text
export const EvalSessionPartDefinition: PromptPartDefinition<EvalSessionPart> = {
	type: 'evalSession',
	priority: -120,
	buildContent(part: EvalSessionPart) {
		return [
